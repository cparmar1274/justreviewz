...
public class MongoService {
	...
	public MongoService() {
		...
		try {
			...
			String database = "heroku_4rqpl385"; // the name of the database in
			...
			MongoClientURI uri = new MongoClientURI("mongodb://admin:password1@ds255857.mlab.com:55857/?authSource=db1");
