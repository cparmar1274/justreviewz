(function() {
    function AnalyticsDashboardChartsCtrl() {
        ...
        function generateSparklineData(index, type) {
            var data = [ pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100), pxDemo.getRandomData(300, 100) ];
    ...
    angular.module("pixeladmin").controller("AnalyticsDashboardChartsCtrl", AnalyticsDashboardChartsCtrl).controller("AnalyticsDashboardTrendingCtrl", AnalyticsDashboardTrendingCtrl);
})();