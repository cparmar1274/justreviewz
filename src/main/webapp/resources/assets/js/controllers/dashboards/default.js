(function() {
    function DefaultDashboardChartsCtrl($http, $scope, DTOptionsBuilder) {
        ...
        self.lastUpdatedOn = "Last updated on";
        self.morrisOptions = {
            xkey: "ratingDate",
        ...
        $http.get("getTrendingData").then(function(response) {
            if (response.data.success == true) self.trendingKeywords = response.data.data;
        });
    ...
    angular.module("pixeladmin").controller("DefaultDashboardChartsCtrl", DefaultDashboardChartsCtrl);
})();