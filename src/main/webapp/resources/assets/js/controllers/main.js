...
(function() {
  ...
  function MainCtrl($rootScope,$http) {
    ...
    self.notifications = [];
    self.engineVersion = "v1.0.5-beta";
	...
	self.markNotification = function(notificationID){
		$http.post('markNotification',{"notificationID":notificationID}).then(function(response) {
  ...
  angular.module('pixeladmin')
    .controller('MainCtrl', [ '$rootScope','$http' ,MainCtrl ]);
