!function(t, e) {
    ...
    return function(t) {
        ...
        void 0 !== (i = function(t) {
            return t;
        }.apply(e, [ r(1), r(3), r(4) ])) && (t.exports = i);
    }, function(t, e, r) {
        var i;
        void 0 !== (i = function(t) {
            function e(r) {
            ...
            function n(t, e, r) {
                return function n() {
                    ...
                    return o[B](s) ? function(t, e) {
                        for (var r = 0, i = t.length; r < i; r++) if (t[r] === e) return t.push(t.splice(r, 1)[0]);
                    }(l, s) : (1e3 <= l.length && delete o[l.shift()], l.push(s), o[s] = t[T](e, a)), 
                    r ? r(o[s]) : o[s];
                };
            }
            function a() {
            ...
            function l(t, e, r, i, n, a, s, l, h) {
                null == h && (h = 1);
                for (var u = (h = 1 < h ? 1 : h < 0 ? 0 : h) / 2, c = [ -.1252, .1252, -.3678, .3678, -.5873, .5873, -.7699, .7699, -.9041, .9041, -.9816, .9816 ], f = [ .2491, .2491, .2335, .2335, .2032, .2032, .1601, .1601, .1069, .1069, .0472, .0472 ], p = 0, d = 0; d < 12; d++) {
            ...
            function u(t, e, r, i, n, a, s, o) {
                if (!(D(t, r) < q(n, s) || q(t, r) > D(n, s) || D(e, i) < q(a, o) || q(e, i) > D(a, o))) {
                    var u = (t - r) * (a - o) - (e - i) * (n - s);
                    if (u) {
                        var c = ((t * i - e * r) * (n - s) - (t - r) * (n * o - a * s)) / u, f = ((t * i - e * r) * (a - o) - (e - i) * (n * o - a * s)) / u, p = +c.toFixed(2), d = +f.toFixed(2);
            ...
            function c(t, r, i) {
                ...
                for (v = 0; v < h; v++) for (var y = 0; y < c; y++) {
                    var m = f[v], b = f[v + 1], _ = p[y], w = p[y + 1], k = O(b.x - m.x) < .001 ? "y" : "x", B = O(w.x - _.x) < .001 ? "y" : "x", C = u(m.x, m.y, b.x, b.y, _.x, _.y, w.x, w.y);
                    if (C) {
                        if (d[C.x.toFixed(4)] == C.y.toFixed(4)) continue;
                        d[C.x.toFixed(4)] = C.y.toFixed(4);
                        var S = m.t + O((C[k] - m[k]) / (b[k] - m[k])) * (b.t - m.t), A = _.t + O((C[B] - _[B]) / (w[B] - _[B])) * (w.t - _.t);
                        0 <= S && S <= 1.001 && 0 <= A && A <= 1.001 && (i ? g++ : g.push({
                            x: C.x,
                            y: C.y,
                            t1: q(S, 1),
                            t2: q(A, 1)
            ...
            function f(t, r, i) {
                ...
                for (var n, a, s, o, l, h, u, f, p, d, g = i ? 0 : [], v = 0, x = t.length; v < x; v++) {
                    ...
                    if ("M" == y[0]) n = l = y[1], a = h = y[2]; else {
                        a = "C" == y[0] ? (n = (p = [ n, a ].concat(y.slice(1)))[6], p[7]) : (p = [ n, a, n, a, l, h, l, h ], 
                        n = l, h);
                        for (var m = 0, b = r.length; m < b; m++) {
                            var _ = r[m];
                            if ("M" == _[0]) s = u = _[1], o = f = _[2]; else {
                                o = "C" == _[0] ? (s = (d = [ s, o ].concat(_.slice(1)))[6], d[7]) : (d = [ s, o, s, o, u, f, u, f ], 
                                s = u, f);
                                var w = c(p, d, i);
                                if (i) g += w; else {
                                    for (var k = 0, B = w.length; k < B; k++) w[k].segment1 = v, w[k].segment2 = m, 
                                    w[k].bez1 = p, w[k].bez2 = d;
                                    g = g.concat(w);
                                }
                            }
                        }
            ...
            function p(t, e, r, i, n, a) {
                this.f = null != t ? (this.a = +t, this.b = +e, this.c = +r, this.d = +i, this.e = +n, 
                +a) : (this.a = 1, this.b = 0, this.c = 0, this.d = 1, this.e = 0);
            }
            function d() {
                ...
                return function(t, e) {
                    var r = function(t, e) {
                        ...
                        for (n = t, c = 0; c < 8; c++) {
                            ...
                            if (O(o = (3 * u * n + 2 * h) * n + l) < 1e-6) break;
                            n -= a / o;
                        }
                        if ((n = t) < (r = 0)) return r;
                        if ((i = 1) < n) return i;
            ...
            function x(r, i, n, a, s, o) {
                ...
                for (var w = 0, k = r.percents.length; w < k; w++) {
                    if (r.percents[w] == n || r.percents[w] > a * r.top) {
                        n = r.percents[w], f = r.percents[w - 1] || 0, v = v / r.top * (n - f), c = r.percents[w + 1], 
                        l = r.anim[n];
                        break;
                    }
                ...
                if (l) {
                    if (h) h.initstatus = a, h.start = new Date() - h.ms * a; else {
                        for (var C in l) if (l[B](C) && (et[B](C) || i.paper.customAttributes[B](C))) switch (x[C] = i.attr(C), 
                        null == x[C] && (x[C] = tt[C]), y[C] = l[C], et[C]) {
                          case W:
                            m[C] = (y[C] - x[C]) / v;
                            break;
                          ...
                          case "transform":
                            ...
                            if (F) for (x[C] = F.from, y[C] = F.to, m[C] = [], m[C].real = !0, w = 0, k = x[C].length; w < k; w++) for (m[C][w] = [ x[C][w][0] ], 
                            M = 1, N = x[C][w].length; M < N; M++) m[C][w][M] = (y[C][w][M] - x[C][w][M]) / v; else {
                        ...
                        if (b = {
                            anim: r,
                            percent: n,
                            timestamp: d = l.start || r.start || +new Date(),
                            start: d + (r.del || 0),
                            status: 0,
                            initstatus: a || 0,
                            stop: !1,
            ...
            }, T = "apply", E = "concat", M = "ontouchstart" in C.win || C.win.DocumentTouch && C.doc instanceof DocumentTouch, N = "", L = " ", z = String, P = "split", F = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel"[P](L), R = {
                mousedown: "touchstart",
                mousemove: "touchmove",
                mouseup: "touchend"
            }, j = z.prototype.toLowerCase, I = Math, D = I.max, q = I.min, O = I.abs, V = I.pow, Y = I.PI, W = "number", G = "array", H = Object.prototype.toString, X = (e._ISURL = /^url\(['"]?(.+?)['"]?\)$/i, 
            /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i), U = {
                ...
                Infinity: 1,
                "-Infinity": 1
            }, $ = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/, Z = I.round, Q = parseFloat, J = parseInt, K = z.prototype.toUpperCase, tt = e._availableAttrs = {
                "arrow-end": "none",
                "arrow-start": "none",
                blur: 0,
                ...
                x: W,
                y: W
            }, rt = /[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/, it = {
                hs: 1,
                rg: 1
            }, nt = /,?([achlmqrstvxz]),?/gi, at = /([achlmrqstvz])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, st = /([rstm])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, ot = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/gi, lt = (e._radial_gradient = /^r(?:\(([^,]+?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*([^\)]+?)\))?/, 
            {}), ht = function(t, e) {
                return Q(t) - Q(e);
            }, ut = function(t) {
                return t;
                ...
                if (!e) return t;
                var r, i, n, a, s, o, l;
                for (n = 0, s = (t = zt(t)).length; n < s; n++) for (a = 1, o = (l = t[n]).length; a < o; a += 2) r = e.x(l[a], l[a + 1]), 
                i = e.y(l[a], l[a + 1]), l[a] = r, l[a + 1] = i;
                return t;
            };
            if (e._g = C, "VML" == (e.type = C.win.SVGAngle || C.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML")) {
                var gt, vt = C.doc.createElement("div");
                if (vt.innerHTML = '<v:shape adj="1"/>', (gt = vt.firstChild).style.behavior = "url(#default#VML)", 
                !gt || "object" != typeof gt.adj) return e.type = N;
                vt = null;
            }
            e.svg = !(e.vml = "VML" == e.type), e._Paper = A, e.fn = b = A.prototype = e.prototype, 
            e._id = 0, e.is = function(t, e) {
                return "finite" == (e = j.call(e)) ? !U[B](+t) : "array" == e ? t instanceof Array : "null" == e && null === t || e == typeof t && null !== t || "object" == e && t === Object(t) || "array" == e && Array.isArray && Array.isArray(t) || H.call(t).slice(8, -1).toLowerCase() == e;
            }, e.angle = function(t, r, i, n, a, s) {
                if (null != a) return e.angle(t, r, a, s) - e.angle(i, n, a, s);
                var o = t - i, l = r - n;
            ...
            var xt = function(t) {
                if (e.vml) {
                    ...
                    o.title = "Raphaël Colour Picker", o.style.display = "none", C.doc.body.appendChild(o), 
                    xt = n(function(t) {
                ...
                r = t.g, t = t.r), null == r && e.is(t, "string")) {
                    var n = e.getRGB(t);
                    t = n.r, r = n.g, i = n.b;
                }
                return (1 < t || 1 < r || 1 < i) && (t /= 255, r /= 255, i /= 255), [ t, r, i ];
            }, wt = function(t, r, i, n) {
                var a = {
                    r: t *= 255,
                    g: r *= 255,
            ...
            e.color = function(t) {
                ...
                t.r = r.r, t.g = r.g, t.b = r.b, t.hex = r.hex) : e.is(t, "object") && "h" in t && "s" in t && "l" in t ? (r = e.hsl2rgb(t), 
                t.r = r.r, t.g = r.g, t.b = r.b, t.hex = r.hex) : (e.is(t, "string") && (t = e.getRGB(t)), 
                e.is(t, "object") && "r" in t && "g" in t && "b" in t ? (r = e.rgb2hsl(t), t.h = r.h, 
                t.s = r.s, t.l = r.l, r = e.rgb2hsb(t), t.v = r.b) : (t = {
                    hex: "none"
                }).r = t.g = t.b = t.h = t.s = t.v = t.l = -1), t.toString = bt, t;
            }, e.hsb2rgb = function(t, e, r, i) {
                var n, a, s, o, l;
                return this.is(t, "object") && "h" in t && "s" in t && "b" in t && (r = t.b, e = t.s, 
                i = t.o, t = t.h), t = (t *= 360) % 360 / 60, o = (l = r * e) * (1 - O(t % 2 - 1)), 
                n = a = s = r - l, wt(n += [ l, o, 0, 0, o, l ][t = ~~t], a += [ o, l, l, o, 0, 0 ][t], s += [ 0, 0, o, l, l, o ][t], i);
            }, e.hsl2rgb = function(t, e, r, i) {
                var n, a, s, o, l;
                return this.is(t, "object") && "h" in t && "s" in t && "l" in t && (r = t.l, e = t.s, 
                t = t.h), (1 < t || 1 < e || 1 < r) && (t /= 360, e /= 100, r /= 100), t = (t *= 360) % 360 / 60, 
                o = (l = 2 * e * (r < .5 ? r : 1 - r)) * (1 - O(t % 2 - 1)), n = a = s = r - l / 2, 
                wt(n += [ l, o, 0, 0, o, l ][t = ~~t], a += [ o, l, l, o, 0, 0 ][t], s += [ 0, 0, o, l, l, o ][t], i);
            }, e.rgb2hsb = function(t, e, r) {
                var a, s;
                return t = (r = _t(t, e, r))[0], e = r[1], r = r[2], {
                    h: ((0 == (s = (a = D(t, e, r)) - q(t, e, r)) ? null : a == t ? (e - r) / s : a == e ? (r - t) / s + 2 : (t - e) / s + 4) + 360) % 6 * 60 / 360,
                    s: 0 == s ? 0 : s / a,
                    b: a,
                    toString: yt
                };
                ...
                var a, s, o, l;
                return t = (r = _t(t, e, r))[0], e = r[1], r = r[2], a = ((s = D(t, e, r)) + (o = q(t, e, r))) / 2, 
                {
                    h: ((0 == (l = s - o) ? null : s == t ? (e - r) / l : s == e ? (r - t) / l + 2 : (t - e) / l + 4) + 360) % 6 * 60 / 360,
                    s: 0 == l ? 0 : a < .5 ? l / (2 * a) : l / (2 - 2 * a),
                    l: a,
                    toString: mt
                };
                ...
                return h ? (h[2] && (n = J(h[2].substring(5), 16), i = J(h[2].substring(3, 5), 16), 
                r = J(h[2].substring(1, 3), 16)), h[3] && (n = J((o = h[3].charAt(3)) + o, 16), 
                i = J((o = h[3].charAt(2)) + o, 16), r = J((o = h[3].charAt(1)) + o, 16)), h[4] && (l = h[4][P](rt), 
                r = Q(l[0]), "%" == l[0].slice(-1) && (r *= 2.55), i = Q(l[1]), "%" == l[1].slice(-1) && (i *= 2.55), 
                n = Q(l[2]), "%" == l[2].slice(-1) && (n *= 2.55), "rgba" == h[1].toLowerCase().slice(0, 4) && (s = Q(l[3])), 
                l[3] && "%" == l[3].slice(-1) && (s /= 100)), h[5] ? (l = h[5][P](rt), r = Q(l[0]), 
                "%" == l[0].slice(-1) && (r *= 2.55), i = Q(l[1]), "%" == l[1].slice(-1) && (i *= 2.55), 
                n = Q(l[2]), "%" == l[2].slice(-1) && (n *= 2.55), ("deg" == l[0].slice(-3) || "°" == l[0].slice(-1)) && (r /= 360), 
                "hsba" == h[1].toLowerCase().slice(0, 4) && (s = Q(l[3])), l[3] && "%" == l[3].slice(-1) && (s /= 100), 
                e.hsb2rgb(r, i, n, s)) : h[6] ? (l = h[6][P](rt), r = Q(l[0]), "%" == l[0].slice(-1) && (r *= 2.55), 
                i = Q(l[1]), "%" == l[1].slice(-1) && (i *= 2.55), n = Q(l[2]), "%" == l[2].slice(-1) && (n *= 2.55), 
                ("deg" == l[0].slice(-3) || "°" == l[0].slice(-1)) && (r /= 360), "hsla" == h[1].toLowerCase().slice(0, 4) && (s = Q(l[3])), 
                l[3] && "%" == l[3].slice(-1) && (s /= 100), e.hsl2rgb(r, i, n, s)) : ((h = {
                    r: r,
                    g: i,
                    b: n,
                    toString: a
                }).hex = "#" + (16777216 | n | i << 8 | r << 16).toString(16).slice(1), e.is(s, "finite") && (h.opacity = s), 
                h)) : {
                    r: -1,
                    g: -1,
                    b: -1,
                ...
                return e.is(t, G) && e.is(t[0], G) && (n = Ct(t)), n.length || z(t).replace(at, function(t, e, r) {
                    ...
                    if (r.replace(ot, function(t, e) {
                        e && a.push(+e);
                    }), "m" == s && 2 < a.length && (n.push([ e ][E](a.splice(0, 2))), s = "l", e = "m" == e ? "l" : "L"), 
                    "r" == s) n.push([ e ][E](a)); else for (;a.length >= i[s] && (n.push([ e ][E](a.splice(0, i[s]))), 
                    i[s]); ) ;
                ...
                return e.is(t, G) && e.is(t[0], G) && (r = Ct(t)), r.length || z(t).replace(st, function(t, e, i) {
                    var n = [];
                    j.call(e), i.replace(ot, function(t, e) {
                        e && n.push(+e);
                    }), r.push([ e ][E](n));
            ...
            e.findDotsAtSegment = function(t, e, r, i, n, a, s, o, l) {
                var h = 1 - l, u = V(h, 3), c = V(h, 2), f = l * l, p = f * l, d = u * t + 3 * c * l * r + 3 * h * l * l * n + p * s, g = u * e + 3 * c * l * i + 3 * h * l * l * a + p * o, v = t + 2 * l * (r - t) + f * (n - 2 * r + t), x = e + 2 * l * (i - e) + f * (a - 2 * i + e), y = r + 2 * l * (n - r) + f * (s - 2 * n + r), m = i + 2 * l * (a - i) + f * (o - 2 * a + i), b = h * t + l * r, _ = h * e + l * i, w = h * n + l * s, k = h * a + l * o, B = 90 - 180 * I.atan2(v - y, x - m) / Y;
                return (y < v || x < m) && (B += 180), {
                    x: d,
                    y: g,
                    m: {
                        x: v,
            ...
            var Bt = e.pathBBox = function(t) {
                ...
                for (var i, n = 0, a = 0, s = [], o = [], l = 0, h = (t = zt(t)).length; l < h; l++) if ("M" == (i = t[l])[0]) n = i[1], 
                a = i[2], s.push(n), o.push(a); else {
                    var u = Lt(n, a, i[1], i[2], i[3], i[4], i[5], i[6]);
                    s = s[E](u.min.x, u.max.x), o = o[E](u.min.y, u.max.y), n = i[5], a = i[6];
                }
                var c = q[T](0, s), f = q[T](0, o), p = D[T](0, s), d = D[T](0, o), g = p - c, v = d - f, x = {
                    x: c,
                    y: f,
                    x2: p,
                    y2: d,
                ...
                for (var h = l, u = t.length; h < u; h++) {
                    ...
                    if (f[0] != j.call(f[0])) switch (c[0] = j.call(f[0]), c[0]) {
                      case "a":
                        c[1] = f[1], c[2] = f[2], c[3] = f[3], c[4] = f[4], c[5] = f[5], c[6] = +(f[6] - n).toFixed(3), 
                        c[7] = +(f[7] - a).toFixed(3);
                        break;
                ...
                for (var u, c, f = 3 == t.length && "M" == t[0][0] && "R" == t[1][0].toUpperCase() && "Z" == t[2][0].toUpperCase(), p = h, d = t.length; p < d; p++) {
                    if (i.push(u = []), (c = t[p])[0] != K.call(c[0])) switch (u[0] = K.call(c[0]), 
                    u[0]) {
                      case "A":
                        u[1] = c[1], u[2] = c[2], u[3] = c[3], u[4] = c[4], u[5] = c[5], u[6] = +(c[6] + n), 
                        u[7] = +(c[7] + a);
                        break;
                      ...
                      case "R":
                        for (var g = [ n, a ][E](c.slice(1)), v = 2, x = g.length; v < x; v++) g[v] = +g[v] + n, 
                        g[++v] = +g[v] + a;
                        i.pop(), i = i[E](s(g, f));
                        break;
                    ...
                    } else if ("R" == c[0]) g = [ n, a ][E](c.slice(1)), i.pop(), i = i[E](s(g, f)), 
                    u = [ "R" ][E](c.slice(-2)); else for (var y = 0, m = c.length; y < m; y++) u[y] = c[y];
                    switch (u[0]) {
                      case "Z":
                        n = o, a = l;
                        break;
                ...
                if (u) B = u[0], C = u[1], w = u[2], k = u[3]; else {
                    t = (c = g(t, e, -p)).x, e = c.y, l = (c = g(l, h, -p)).x, h = c.y, I.cos(Y / 180 * a), 
                    I.sin(Y / 180 * a);
                    var v = (t - l) / 2, x = (e - h) / 2, y = v * v / (r * r) + x * x / (i * i);
                    1 < y && (r *= y = I.sqrt(y), i *= y);
                    var m = r * r, b = i * i, _ = (s == o ? -1 : 1) * I.sqrt(O((m * b - m * x * x - b * v * v) / (m * x * x + b * v * v))), w = _ * r * x / i + (t + l) / 2, k = _ * -i * v / r + (e + h) / 2, B = I.asin(((e - k) / i).toFixed(9)), C = I.asin(((h - k) / i).toFixed(9));
                    (B = t < w ? Y - B : B) < 0 && (B = 2 * Y + B), (C = l < w ? Y - C : C) < 0 && (C = 2 * Y + C), 
                    o && C < B && (B -= 2 * Y), !o && B < C && (C -= 2 * Y);
                }
                var S = C - B;
                if (O(S) > f) {
                    var A = C, T = l, M = h;
                    C = B + f * (o && B < C ? 1 : -1), l = w + r * I.cos(C), h = k + i * I.sin(C), d = Mt(l, h, r, i, a, 0, o, T, M, [ C, A, w, k ]);
                }
                S = C - B;
                var N = I.cos(B), L = I.sin(B), z = I.cos(C), F = I.sin(C), R = I.tan(S / 4), j = 4 / 3 * r * R, D = 4 / 3 * i * R, q = [ t, e ], V = [ t + j * L, e - D * N ], W = [ l + j * F, h - D * z ], G = [ l, h ];
                ...
                var l, h = n - 2 * r + t - (s - 2 * n + r), u = 2 * (r - t) - 2 * (n - r), c = t - r, f = (-u + I.sqrt(u * u - 4 * h * c)) / 2 / h, p = (-u - I.sqrt(u * u - 4 * h * c)) / 2 / h, d = [ e, o ], g = [ t, s ];
                return "1e12" < O(f) && (f = .5), "1e12" < O(p) && (p = .5), 0 < f && f < 1 && (l = Nt(t, e, r, i, n, a, s, o, f), 
                g.push(l.x), d.push(l.y)), 0 < p && p < 1 && (l = Nt(t, e, r, i, n, a, s, o, p), 
                g.push(l.x), d.push(l.y)), h = a - 2 * i + e - (o - 2 * a + i), c = e - i, f = (-(u = 2 * (i - e) - 2 * (a - i)) + I.sqrt(u * u - 4 * h * c)) / 2 / h, 
                p = (-u - I.sqrt(u * u - 4 * h * c)) / 2 / h, "1e12" < O(f) && (f = .5), "1e12" < O(p) && (p = .5), 
                0 < f && f < 1 && (l = Nt(t, e, r, i, n, a, s, o, f), g.push(l.x), d.push(l.y)), 
                0 < p && p < 1 && (l = Nt(t, e, r, i, n, a, s, o, p), g.push(l.x), d.push(l.y)), 
                {
                    min: {
                        x: q[T](0, g),
                        y: q[T](0, d)
                ...
                for (var i = At(t), n = e && At(e), a = {
                    ...
                    switch (!(t[0] in {
                      ...
                      case "T":
                        e.qy = "Q" == r || "T" == r ? (e.qx = 2 * e.x - e.qx, 2 * e.y - e.qy) : (e.qx = e.x, 
                        e.y), t = [ "C" ][E](Et(e.x, e.y, e.qx, e.qy, t[1], t[2]));
                        break;
                    ...
                    r.bx = 0, r.by = 0, r.x = t[s][1], r.y = t[s][2], g = D(i.length, n && n.length || 0));
                }, u = [], c = [], f = "", p = "", d = 0, g = D(i.length, n && n.length || 0); d < g; d++) {
                    i[d] && (f = i[d][0]), "C" != f && (u[d] = f, d && (p = u[d - 1])), i[d] = o(i[d], a, p), 
                    "A" != u[d] && "C" == f && (u[d] = "C"), l(i, d), n && (n[d] && (f = n[d][0]), "C" != f && (c[d] = f, 
                    d && (p = c[d - 1])), n[d] = o(n[d], s, p), "A" != c[d] && "C" == f && (c[d] = "C"), 
                    l(n, d)), h(i, n, a, s, d), h(n, i, s, a, d);
                    var v = i[d], x = n && n[d], y = v.length, m = n && x.length;
                    a.x = v[y - 2], a.y = v[y - 1], a.bx = Q(v[y - 4]) || a.x, a.by = Q(v[y - 3]) || a.y, 
                    s.bx = n && (Q(x[m - 4]) || s.x), s.by = n && (Q(x[m - 3]) || s.y), s.x = n && x[m - 2], 
                    s.y = n && x[m - 1];
                }
                ...
                for (var r = [], i = 0, n = t.length; i < n; i++) {
                    ...
                    a.opacity = a.color.opacity, a.color = a.color.hex, s[2] && (a.offset = s[2] + "%"), 
                    r.push(a);
                }
                ...
                e.bottom !== t && (Pt(t, e), t.next = e.bottom, t.prev = null, e.bottom.prev = t, 
                e.bottom = t);
            }, e._insertafter = function(t, e, r) {
                Pt(t, r), e == r.top && (r.top = t), e.next && (e.next.prev = t), t.next = e.next, 
                (t.prev = e).next = t;
            }, e._insertbefore = function(t, e, r) {
                Pt(t, r), e == r.bottom && (r.bottom = t), e.prev && (e.prev.next = t), t.prev = e.prev, 
                (e.prev = t).next = e;
                ...
                var a, s, i = e.parseTransformString(r), n = 0, o = 1, l = 1, h = t._, u = new p();
                if (h.transform = i || [], i) for (var c = 0, f = i.length; c < f; c++) {
                    var d, g, v, x, y, m = i[c], b = m.length, _ = z(m[0]).toLowerCase(), w = m[0] != _, k = w ? u.invert() : 0;
                    "t" == _ && 3 == b ? w ? (d = k.x(0, 0), g = k.y(0, 0), v = k.x(m[1], m[2]), x = k.y(m[1], m[2]), 
                    u.translate(v - d, x - g)) : u.translate(m[1], m[2]) : "r" == _ ? 2 == b ? (y = y || t.getBBox(1), 
                    u.rotate(m[1], y.x + y.width / 2, y.y + y.height / 2), n += m[1]) : 4 == b && (w ? (v = k.x(m[2], m[3]), 
                    x = k.y(m[2], m[3]), u.rotate(m[1], v, x)) : u.rotate(m[1], m[2], m[3]), n += m[1]) : "s" == _ ? 2 == b || 3 == b ? (y = y || t.getBBox(1), 
                    u.scale(m[1], m[b - 1], y.x + y.width / 2, y.y + y.height / 2), o *= m[1], l *= m[b - 1]) : 5 == b && (w ? (v = k.x(m[3], m[4]), 
                    x = k.y(m[3], m[4]), u.scale(m[1], m[2], v, x)) : u.scale(m[1], m[2], m[3], m[4]), 
                    o *= m[1], l *= m[2]) : "m" == _ && 7 == b && u.add(m[1], m[2], m[3], m[4], m[5], m[6]), 
                ...
                for (var i, n, a, s, o = D(t.length, r.length), l = [], h = [], u = 0; u < o; u++) {
                    ...
                    for (l[u] = [], h[u] = [], i = 0, n = D(a.length, s.length); i < n; i++) i in a && (l[u][i] = a[i]), 
                    i in s && (h[u][i] = s[i]);
                }
                return {
                    from: l,
            ...
            e._getContainer = function(t, r, i, n) {
                ...
                t.add = function(t, e, r, i, n, a) {
                    ...
                    null == e && (e = t), (r || i) && this.add(1, 0, 0, 1, r, i), this.add(t, 0, 0, e, 0, 0), 
                    ...
                    t.scalex = I.sqrt(r(n[0])), i(n[0]), t.shear = n[0][0] * n[1][0] + n[0][1] * n[1][1], 
                    n[1] = [ n[1][0] - n[0][0] * t.shear, n[1][1] - n[0][1] * t.shear ], t.scaley = I.sqrt(r(n[1])), 
                    i(n[1]), t.shear /= t.scaley;
                    var a = -n[0][1], s = n[1][1];
                    return s < 0 ? (t.rotate = e.deg(I.acos(s)), a < 0 && (t.rotate = 360 - t.rotate)) : t.rotate = e.deg(I.asin(a)), 
                    ...
                    e.rotate = +e.rotate.toFixed(4), (e.dx || e.dy ? "t" + [ e.dx, e.dy ] : N) + (1 != e.scalex || 1 != e.scaley ? "s" + [ e.scalex, e.scaley, 0, 0 ] : N) + (e.rotate ? "r" + [ e.rotate, 0, 0 ] : N)) : "m" + [ this.get(0), this.get(1), this.get(2), this.get(3), this.get(4), this.get(5) ];
                };
            }(p.prototype);
            for (var Dt = function() {
                this.returnValue = !1;
                ...
                var e = C.doc.documentElement.scrollTop || C.doc.body.scrollTop, r = C.doc.documentElement.scrollLeft || C.doc.body.scrollLeft;
                return {
                    x: t.clientX + r,
                    y: t.clientY + e
                };
            }, Wt = C.doc.addEventListener ? function(t, e, r, i) {
                var n = function(t) {
                    var e = Yt(t);
                ...
                return function() {
                    return t.removeEventListener(e, n, !1), M && R[e] && t.removeEventListener(R[e], a, !1), 
                    !0;
                };
                ...
                var n = function(t) {
                    ...
                    return t.preventDefault = t.preventDefault || Dt, t.stopPropagation = t.stopPropagation || Ot, 
                    r.call(i, t, a, s);
                };
                return t.attachEvent("on" + e, n), function() {
                    return t.detachEvent("on" + e, n), !0;
                };
            } : void 0, Gt = [], Ht = function(e) {
                for (var r, i = e.clientX, n = e.clientY, a = C.doc.documentElement.scrollTop || C.doc.body.scrollTop, s = C.doc.documentElement.scrollLeft || C.doc.body.scrollLeft, o = Gt.length; o--; ) {
                    ...
                    C.win.opera && p.removeChild(c), c.style.display = "none", u = r.el.paper.getElementByPoint(i, n), 
                    c.style.display = d, C.win.opera && (f ? p.insertBefore(c, f) : p.appendChild(c)), 
                    u && t("raphael.drag.over." + r.el.id, r.el, u), i += s, n += a, t("raphael.drag.move." + r.el.id, r.move_scope || r.el, i - r.el._drag.x, n - r.el._drag.y, i, n, e);
                }
            }, Xt = function(r) {
                ...
                e[t] = Ut[t] = function(r, i) {
                    ...
                    for (var i = this.events || [], n = i.length; n--; ) i[n].name != t || !e.is(r, "undefined") && i[n].f != r || (i[n].unbind(), 
            ...
            Ut.data = function(r, i) {
                ...
                if (1 != arguments.length) return n[r] = i, t("raphael.data.set." + this.id, this, i, r), 
                this;
                if (e.is(r, "object")) {
            ...
            Ut.drag = function(r, i, n, a, s, o) {
                function l(l) {
                    ...
                    var h = l.clientX, u = l.clientY, c = C.doc.documentElement.scrollTop || C.doc.body.scrollTop, f = C.doc.documentElement.scrollLeft || C.doc.body.scrollLeft;
                    ...
                    this._drag.x = h + f, this._drag.y = u + c, !Gt.length && e.mousemove(Ht).mouseup(Xt), 
                    Gt.push({
                        el: this,
                        move_scope: a,
                        start_scope: s,
                        end_scope: o
                    }), i && t.on("raphael.drag.start." + this.id, i), r && t.on("raphael.drag.move." + this.id, r), 
                    n && t.on("raphael.drag.end." + this.id, n), t("raphael.drag.start." + this.id, s || a || this, l.clientX + f, l.clientY + c, l);
                }
                ...
                for (var r = Zt.length; r--; ) Zt[r].el == this && (this.unmousedown(Zt[r].start), 
                Zt.splice(r, 1), t.unbind("raphael.drag.*." + this.id));
            ...
            b.getElementByPoint = function(t, e) {
                ...
                if (C.win.opera && "svg" == n.tagName) {
                    var a = function(t) {
                        var e = t.getBoundingClientRect(), r = t.ownerDocument, i = r.body, n = r.documentElement, a = n.clientTop || i.clientTop || 0, s = n.clientLeft || i.clientLeft || 0;
                        return {
                ...
                return n == r.canvas.parentNode && (n = i), n && n.raphael ? r.getById(n.raphaelid) : null;
                ...
                var e = this._;
                return t ? (!e.dirty && e.bboxwt || (this.realPath = pt[this.type](this), e.bboxwt = Bt(this.realPath), 
                e.bboxwt.toString = d, e.dirty = 0), e.bboxwt) : ((e.dirty || e.dirtyT || !e.bbox) && (!e.dirty && this.realPath || (e.bboxwt = 0, 
                this.realPath = pt[this.type](this)), e.bbox = Bt(dt(this.realPath, this.matrix)), 
                e.bbox.toString = d, e.dirty = e.dirtyT = 0), e.bbox);
            }, Ut.clone = function() {
            ...
            var Jt = function(t, r, i, n, a, s, o, u, c) {
                return null == c ? l(t, r, i, n, a, s, o, u) : e.findDotsAtSegment(t, r, i, n, a, s, o, u, function(t, e, r, i, n, a, s, o, h) {
                    if (!(h < 0 || l(t, e, r, i, n, a, s, o) < h)) {
                        var u, c = .5, f = 1 - c;
                        for (u = l(t, e, r, i, n, a, s, o, f); .01 < O(u - h); ) u = l(t, e, r, i, n, a, s, o, f += (u < h ? 1 : -1) * (c /= 2));
                        return f;
                    }
                }(t, r, i, n, a, s, o, u, c));
            }, Kt = function(t, r) {
                return function(i, n, a) {
                    for (var s, o, l, h, u, c = "", f = {}, p = 0, d = 0, g = (i = zt(i)).length; d < g; d++) {
                        if ("M" == (l = i[d])[0]) s = +l[1], o = +l[2]; else {
                            if (n < p + (h = Jt(s, o, l[1], l[2], l[3], l[4], l[5], l[6]))) {
                                if (r && !f.start) {
                                    if (c += [ "C" + (u = Jt(s, o, l[1], l[2], l[3], l[4], l[5], l[6], n - p)).start.x, u.start.y, u.m.x, u.m.y, u.x, u.y ], 
                                    a) return c;
                                    f.start = c, c = [ "M" + u.x, u.y + "C" + u.n.x, u.n.y, u.end.x, u.end.y, l[5], l[6] ].join(), 
                                    p += h, s = +l[5], o = +l[6];
                                    continue;
                                }
                                if (!t && !r) return {
                                    x: (u = Jt(s, o, l[1], l[2], l[3], l[4], l[5], l[6], n - p)).x,
                                    y: u.y,
                                    alpha: u.alpha
                                };
                            }
            ...
            var ie = e.easing_formulas = {
                ...
                "<>": function(t) {
                    var e = .48 - t / 1.04, r = I.sqrt(.1734 + e * e), i = r - e, n = -r - e, a = V(O(i), 1 / 3) * (i < 0 ? -1 : 1) + V(O(n), 1 / 3) * (n < 0 ? -1 : 1) + .5;
            ...
            ie.easeIn = ie["ease-in"] = ie["<"], ie.easeOut = ie["ease-out"] = ie[">"], ie.easeInOut = ie["ease-in-out"] = ie["<>"], 
            ie["back-in"] = ie.backIn, ie["back-out"] = ie.backOut;
            var ne = [], ae = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
                setTimeout(t, 16);
            }, se = function() {
                for (var r = +new Date(), i = 0; i < ne.length; i++) {
                    ...
                    if (!n.el.removed && !n.paused) {
                        ...
                        n.status = n.initstatus, delete n.initstatus, n.stop && ne.splice(i--, 1)) : n.status = (n.prev + (n.percent - n.prev) * (o / l)) / n.anim.top, 
                        !(o < 0)) if (o < l) {
                            var v = h(o / l);
                            for (var y in u) if (u[B](y)) {
                                switch (et[y]) {
                                  ...
                                  case "transform":
                                    if (c[y].real) for (a = [], m = 0, b = u[y].length; m < b; m++) for (a[m] = [ u[y][m][0] ], 
                                    _ = 1, w = u[y][m].length; _ < w; _++) a[m][_] = u[y][m][_] + v * l * c[y][m][_]; else {
                                        var k = function(t) {
                            ...
                            }(n.callback, p, n.anim), p.attr(f), ne.splice(i--, 1), 1 < n.repeat && !n.next) {
            ...
            var le = function(t) {
                if (this.items = [], this.length = 0, this.type = "set", t) for (var e = 0, r = t.length; e < r; e++) !t[e] || t[e].constructor != Ut.constructor && t[e].constructor != le || (this[this.items.length] = this.items[this.items.length] = t[e], 
                this.length++);
            }, he = le.prototype;
            for (var ue in he.push = function() {
                for (var t, e, r = 0, i = arguments.length; r < i; r++) !(t = arguments[r]) || t.constructor != Ut.constructor && t.constructor != le || (this[e = this.items.length] = this.items[e] = t, 
                this.length++);
                return this;
            }, he.pop = function() {
            ...
            return he.attr = function(t, r) {
                ...
                for (var e = 0, r = this.length; e < r; e++) if (this[e] == t) return this.splice(e, 1), 
                !0;
                ...
                if (this.fonts[r] ? this.fonts[r].push(e) : this.fonts[r] = [ e ], !t.svg) for (var n in e.face["units-per-em"] = J(t.face["units-per-em"], 10), 
                t.glyphs) if (t.glyphs[B](n)) {
                    var a = t.glyphs[n];
                    if (e.glyphs[n] = {
                        w: a.w,
                        k: {},
                ...
                if (e.is(t, "array")) for (var r, i = this.set(), n = 0, a = t.length; n < a; n++) r = t[n] || {}, 
                w[B](r.type) && i.push(this[r.type]().attr(r));
                return i;
        ...
        }.apply(e, [ r(2) ])) && (t.exports = i);
    }, function(t, e, r) {
        var n, a, s, o, l, h, u, c, f, p, d, g, v;
        o = "hasOwnProperty", l = /[\.\/]/, h = /\s*,\s*/, u = function(t, e) {
            return t - e;
        }, c = {
            n: {}
        }, f = function() {
            ...
            var r, i = s, n = Array.prototype.slice.call(arguments, 2), o = eve.listeners(t), l = 0, h = [], c = {}, d = [], g = a;
            d.firstDefined = f, d.lastDefined = p, a = t;
            for (var v = s = 0, x = o.length; v < x; v++) "zIndex" in o[v] && (h.push(o[v].zIndex), 
            o[v].zIndex < 0 && (c[o[v].zIndex] = o[v]));
            for (h.sort(u); h[l] < 0; ) if (r = c[h[l++]], d.push(r.apply(e, n)), s) return s = i, 
            d;
            for (v = 0; v < x; v++) if ("zIndex" in (r = o[v])) if (r.zIndex == h[l]) {
                if (d.push(r.apply(e, n)), s) break;
                do {
                    if ((r = c[h[++l]]) && d.push(r.apply(e, n)), s) break;
                } while (r);
            ...
            for (n = 0, a = u.length; n < a; n++) {
                for (h = [], s = 0, o = p.length; s < o; s++) for (r = [ (f = p[s].n)[u[n]], f["*"] ], 
                i = 2; i--; ) (e = r[i]) && (h.push(e), d = d.concat(e.f || []));
                p = h;
            }
            return d;
        }, eve.separator = function(t) {
            l = t ? (t = "[" + (t = g(t).replace(/(?=[\.\^\]\[\-])/g, "\\")) + "]", new RegExp(t)) : /[\.\/]/;
        }, eve.on = function(t, e) {
            ...
            if (t) {
                ...
                if (1 < r.length) for (var i = 0, n = r.length; i < n; i++) eve.off(r[i], e); else {
                    r = v(t) ? t : g(t).split(l);
                    var a, s, u, f, p, d = [ c ];
                    ...
                    for (i = 0, n = d.length; i < n; i++) for (a = d[i]; a.n; ) {
                        ...
                        } else for (s in delete a.f, a.n) a.n[o](s) && a.n[s].f && delete a.n[s].f;
                        a = a.n;
                    }
                }
            } else eve._events = c = {
        ...
        void 0 !== (i = function(t) {
            if (!t || t.svg) {
                ...
                var v = function(i, n) {
                    if (n) for (var a in "string" == typeof i && (i = v(i)), n) n[e](a) && ("xlink:" == a.substring(0, 6) ? i.setAttributeNS(p, a.substring(6), r(n[a])) : i.setAttribute(a, r(n[a]))); else (i = t._g.doc.createElementNS("http://www.w3.org/2000/svg", i)).style && (i.style.webkitTapHighlightColor = "rgba(0,0,0,0)");
                    return i;
                }, x = function(e, n) {
                    ...
                    if (!y) {
                        if (n = (n = r(n).replace(t._radial_gradient, function(t, e, r) {
                            if (h = "radial", e && r) {
                                f = i(e);
                                var n = 2 * (.5 < (p = i(r))) - 1;
                                .25 < l(f - .5, 2) + l(p - .5, 2) && (p = a.sqrt(.25 - l(f - .5, 2)) * n + .5) && .5 != p && (p = p.toFixed(5) - 1e-5 * n);
                            }
                            return c;
                        })).split(/\s*\-\s*/), "linear" == h) {
                            var b = n.shift();
                            ...
                            _[2] *= w, _[3] *= w, _[2] < 0 && (_[0] = -_[2], _[2] = 0), _[3] < 0 && (_[1] = -_[3], 
                            _[3] = 0);
                        }
                        var k = t._parseDots(n);
                        if (!k) return null;
                        if (u = u.replace(/[\(\)\s,\xb0#]/g, "_"), e.gradient && u != e.gradient.id && (g.defs.removeChild(e.gradient), 
                    ...
                    return v(d, {
                        ...
                        opacity: 1,
                        "fill-opacity": 1
                    }), x.fill = c, x.opacity = 1, x.fillOpacity = 1;
                }, m = function(t) {
                    if (function() {
                    ...
                    if ("path" == i.type) {
                        ...
                        if (u = "open" == w ? (k += 2, B += 2, C += 2, l = 1, h = a ? 4 : 1, {
                            fill: "none",
                            stroke: m.stroke
                        }) : (h = l = k / 2, {
                            fill: m.stroke,
                        ...
                        i._.arrows.startMarker && g[i._.arrows.startMarker]--) : i._.arrows = {}, "none" != w) {
                            ...
                            o = a ? (s = i._.arrows.startdx * b || 0, t.getTotalLength(m.path) - M * b) : (s = M * b, 
                            t.getTotalLength(m.path) - (i._.arrows.enddx * b || 0)), (u = {})["marker-" + x] = "url(#" + A + ")", 
                            (o || s) && (u.d = t.getSubpath(m.path, s, o)), v(y, u), i._.arrows[x + "Path"] = S, 
                            i._.arrows[x + "Marker"] = A, i._.arrows[x + "dx"] = M, i._.arrows[x + "Type"] = w, 
                            i._.arrows[x + "String"] = n;
                        } else o = a ? (s = i._.arrows.startdx * b || 0, t.getTotalLength(m.path) - s) : (s = 0, 
                        t.getTotalLength(m.path) - (i._.arrows.enddx * b || 0)), i._.arrows[x + "Path"] && v(y, {
                            d: t.getSubpath(m.path, s, o)
                        }), delete i._.arrows[x + "Path"], delete i._.arrows[x + "Marker"], delete i._.arrows[x + "dx"], 
                        delete i._.arrows[x + "Type"], delete i._.arrows[x + "String"];
                    ...
                    for (var d in l.style.visibility = "hidden", a) if (a[e](d)) {
                        ...
                        switch (u[d] = g, d) {
                          ...
                          case "stroke-width":
                            1 == i._.sx && 1 == i._.sy || (g /= s(o(i._.sx), o(i._.sy)) || 1), l.setAttribute(d, g), 
                            u["stroke-dasharray"] && k(i, u["stroke-dasharray"], a), i._.arrows && ("startString" in i._.arrows && _(i, i._.arrows.startString), 
                            "endString" in i._.arrows && _(i, i._.arrows.endString, 1));
                            break;
                          ...
                          case "fill":
                            ...
                            z[e]("opacity") && v(l, {
                                "fill-opacity": 1 < z.opacity ? z.opacity / 100 : z.opacity
                            });

                          case "stroke":
                            z = t.getRGB(g), l.setAttribute(d, z.hex), "stroke" == d && z[e]("opacity") && v(l, {
                                "stroke-opacity": 1 < z.opacity ? z.opacity / 100 : z.opacity
                          ...
                          case "opacity":
                            u.gradient && !u[e]("stroke-opacity") && v(l, {
                                "stroke-opacity": 1 < g ? g / 100 : g
                            });

                          case "fill-opacity":
                            if (u.gradient) {
                                (P = t._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, c))) && (F = P.getElementsByTagName("stop"), 
                                v(F[F.length - 1], {
                                    "stop-opacity": g
                                }));
                                break;
                    ...
                    if ("text" == i.type && (a[e]("text") || a[e]("font") || a[e]("font-size") || a[e]("x") || a[e]("y"))) {
                        ...
                        if (a[e]("text")) {
                            ...
                            for (var h, u = r(a.text).split("\n"), f = [], p = 0, d = u.length; p < d; p++) h = v("tspan"), 
                            p && v(h, {
                                dy: 1.2 * l,
                                x: s.x
                    ...
                    this[0] = this.node = e, e.raphael = !0, this.id = ("0000" + (Math.random() * Math.pow(36, 5) << 0).toString(36)).slice(-5), 
                    e.raphaelid = this.id, this.matrix = t.matrix(), this.realPath = null, this.paper = r, 
                    this.attrs = this.attrs || {}, this._ = {
                        ...
                        dy: 0,
                        dirty: 1
                    }, !r.bottom && (r.bottom = this), this.prev = r.top, r.top && (r.top.next = this), 
                    (r.top = this).next = null;
                }, T = t.el;
                (A.prototype = T).constructor = A, t._engine.path = function(t, e) {
                    var r = v("path");
                    ...
                    if ((t = r(t).split(h)).length - 1 && (e = i(t[1]), n = i(t[2])), t = i(t[0]), null == n && (e = n), 
                    null == e || null == n) {
                    ...
                    if (this.removed) return this;
                    if ((t = r(t).split(h)).length - 1 && (e = i(t[1]), n = i(t[2]), a = i(t[3])), t = i(t[0]), 
                    null == e && (e = t), null == a && (n = a), null == n || null == a) var s = this.getBBox(1);
                    return n = null == n ? s.x + s.width / 2 : n, a = null == a ? s.y + s.height / 2 : a, 
                    this.transform(this._.transform.concat([ [ "s", t, e, n, a ] ])), this;
                }, T.translate = function(t, e) {
                    return this.removed || ((t = r(t).split(h)).length - 1 && (e = i(t[1])), t = i(t[0]) || 0, 
                    e = +e || 0, this.transform(this._.transform.concat([ [ "t", t, e ] ]))), this;
                    ...
                    if (!this.removed && e.parentNode) {
                        var r = this.paper;
                        for (var i in r.__set__ && r.__set__.exclude(this), u.unbind("raphael.*.*." + this.id), 
                        this.gradient && r.defs.removeChild(this.gradient), t._tear(this, r), e.parentNode.removeChild(e), 
                        this.removeData(), this) this[i] = "function" == typeof this[i] ? t._removedFactory(i) : null;
                        this.removed = !0;
                    }
                }, T._getBBox = function() {
                    ...
                    return r.insertBefore(e, r.firstChild), t._toback(this, this.paper), this.paper, 
                    this;
                    ...
                    t._g.doc.body.appendChild(l), o = 1) : (l.style.cssText = h + "position:relative", 
                    r.firstChild ? r.insertBefore(l, r.firstChild) : r.appendChild(l)), (r = new t._Paper()).width = a, 
                    r.height = s, r.canvas = l, r.clear(), r._left = r._top = 0, o && (r.renderfix = function() {}), 
                    r.renderfix(), r;
                    ...
                    for (a = null == t ? (this._vbSize && (h = 1), delete this._vbSize, "0 0 " + this.width + f + this.height) : (this._vbSize = h, 
                    t + f + e + f + r + f + i), v(this.canvas, {
                        viewBox: a,
                    ...
                    var i = -t.e % 1, n = -t.f % 1;
                    (i || n) && (i && (this._left = (this._left + i) % 1, r.left = this._left + "px"), 
                    ...
                    for (var e in u("raphael.remove", this), this.canvas.parentNode && this.canvas.parentNode.removeChild(this.canvas), 
                    this) this[e] = "function" == typeof this[e] ? t._removedFactory(e) : null;
                };
                var E = t.st;
        ...
        }.apply(e, [ r(1) ])) && (t.exports = i);
    }, function(t, e, r) {
        var i;
        void 0 !== (i = function(t) {
            if (!t || t.vml) {
                var e = "hasOwnProperty", r = String, i = parseFloat, n = Math, a = n.round, s = n.max, o = n.min, l = n.abs, h = /[, ]+/, u = t.eve, c = " ", f = "", p = {
                    M: "m",
                    L: "l",
                    C: "c",
                    Z: "x",
                    ...
                    c: "v",
                    z: "x"
                }, d = /([clmz]),?([^clmz]*)/gi, g = / progid:\S+Blur\([^\)]+\)/g, v = /-?[^,\s-]+/g, x = "position:absolute;left:0;top:0;width:1px;height:1px;behavior:url(#default#VML)", y = 21600, m = {
                    path: 1,
                    rect: 1,
                    image: 1
                }, b = {
                    ...
                    var s = t._, o = t.matrix, h = s.fillpos, u = t.node, f = u.style, p = 1, d = "", g = y / e, v = y / r;
                    if (f.visibility = "hidden", e && r) {
                        if (u.coordsize = l(g) + c + l(v), f.rotation = a * (e * r < 0 ? -1 : 1), a) {
                            var x = w(a, i, n);
                            i = x.dx, n = x.dy;
                        }
                        if (e < 0 && (d += "x"), r < 0 && (d += " y") && (p = -1), f.flip = d, u.coordorigin = i * -g + c + n * -v, 
                        h || s.fillsize) {
                            var m = u.getElementsByTagName("fill");
                            m = m && m[0], u.removeChild(m), h && (x = w(a, o.x(h[0], h[1]), o.y(h[0], h[1])), 
                            m.position = x.dx * p + c + x.dy * p), s.fillsize && (m.size = s.fillsize[0] * l(e) + c + s.fillsize[1] * l(r)), 
                            u.appendChild(m);
                        }
                ...
                var E, B = function(t, e, i) {
                    ...
                    n.attrs = n.attrs || {};
                    var u = n.node, p = n.attrs, d = u.style, g = m[n.type] && (l.x != p.x || l.y != p.y || l.width != p.width || l.height != p.height || l.cx != p.cx || l.cy != p.cy || l.rx != p.rx || l.ry != p.ry || l.r != p.r), v = b[n.type] && (p.cx != l.cx || p.cy != l.cy || p.r != l.r || p.rx != l.rx || p.ry != l.ry), x = n;
                    for (var w in l) l[e](w) && (p[w] = l[w]);
                    if (g && (p.path = t._getPath[n.type](n), n._.dirty = 1), l.href && (u.href = l.href), 
                    l.title && (u.title = l.title), l.target && (u.target = l.target), l.cursor && (d.cursor = l.cursor), 
                    "blur" in l && n.blur(l.blur), (l.path && "path" == n.type || g) && (u.path = _(~r(p.path).toLowerCase().indexOf("r") ? t._pathToAbsolute(p.path) : p.path), 
                    n._.dirty = 1, "image" == n.type && (n._.fillpos = [ p.x, p.y ], n._.fillsize = [ p.width, p.height ], 
                    k(n, 1, 1, 0, 0, 0))), "transform" in l && n.transform(l.transform), v) {
                        var C = +p.cx, A = +p.cy, T = +p.rx || +p.r || 0, M = +p.ry || +p.r || 0;
                        u.path = t.format("ar{0},{1},{2},{3},{4},{1},{4},{1}x", a((C - T) * y), a((A - M) * y), a((C + T) * y), a((A + M) * y), a(C * y)), 
                        n._.dirty = 1;
                    }
                    if ("clip-rect" in l) {
                        ...
                        if (4 == N.length) {
                            ...
                            z.clip = t.format("rect({1}px {2}px {3}px {0}px)", N), u.clipRect || (z.position = "absolute", 
                            z.top = 0, z.left = 0, z.width = n.paper.width + "px", z.height = n.paper.height + "px", 
                    ...
                    if ("arrow-start" in l && B(x, l["arrow-start"]), "arrow-end" in l && B(x, l["arrow-end"], 1), 
                    null != l.opacity || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
                        ...
                        if (!(F = F && F[0]) && (F = E("fill")), "image" == n.type && l.src && (F.src = l.src), 
                        ...
                        F.on && l.fill) {
                            ...
                            if (R) {
                                ...
                                circle: 1,
                                ellipse: 1
                            } || "r" != r(l.fill).charAt()) && S(x, l.fill, F) && (p.fill = "none", p.gradient = l.fill, 
                            F.rotate = !1);
                        }
                        ...
                        !D && (q = D = E("stroke")), (l.stroke && "none" != l.stroke || l["stroke-width"] || null != l["stroke-opacity"] || l["stroke-dasharray"] || l["stroke-miterlimit"] || l["stroke-linejoin"] || l["stroke-linecap"]) && (D.on = !0), 
                        ("none" == l.stroke || null === l.stroke || null == D.on || 0 == l.stroke || 0 == l["stroke-width"]) && (D.on = !1);
                        ...
                        if (I = o(s(I, 0), 1), null == l["stroke-width"] && (V = p["stroke-width"]), l["stroke-width"] && (D.weight = V), 
                        V && V < 1 && (I *= V) && (D.weight = 1), D.opacity = I, l["stroke-linejoin"] && (D.joinstyle = l["stroke-linejoin"] || "miter"), 
                        D.miterlimit = l["stroke-miterlimit"] || 8, l["stroke-linecap"] && (D.endcap = "butt" == l["stroke-linecap"] ? "flat" : "square" == l["stroke-linecap"] ? "square" : "round"), 
                    ...
                    if ("text" == x.type) {
                        ...
                        d = W.style, p.font && (d.font = p.font), p["font-family"] && (d.fontFamily = p["font-family"]), 
                        p["font-weight"] && (d.fontWeight = p["font-weight"]), p["font-style"] && (d.fontStyle = p["font-style"]), 
                        G = i(p["font-size"] || G && G[0]) || 10, d.fontSize = 100 * G + "px", x.textpath.string && (W.innerHTML = r(x.textpath.string).replace(/</g, "&#60;").replace(/&/g, "&#38;").replace(/\n/g, "<br>"));
                        var H = W.getBoundingClientRect();
                        x.W = p.w = (H.right - H.left) / 100, x.H = p.h = (H.bottom - H.top) / 100, x.X = p.x, 
                        x.Y = p.y + x.H / 2, ("x" in l || "y" in l) && (x.path.v = t.format("m{0},{1}l{2},{1}", a(p.x * y), a(p.y * y), a(p.x * y) + 1));
                    ...
                    if (e.attrs.gradient = a, a = (a = r(a).replace(t._radial_gradient, function(t, e, r) {
                        return l = "radial", e && r && (e = i(e), r = i(r), .25 < o(e - .5, 2) + o(r - .5, 2) && (r = n.sqrt(.25 - o(e - .5, 2)) * (2 * (.5 < r) - 1) + .5), 
                        h = e + c + r), f;
                    })).split(/\s*\-\s*/), "linear" == l) {
                        var u = a.shift();
                    ...
                    if (e = e.shape || e.node, p.length) {
                        ...
                        s.colors = d.length ? d.join() : "0% " + s.color, s.angle = "radial" == l ? (s.type = "gradientTitle", 
                        s.focus = "100%", s.focussize = "0 0", s.focusposition = h, 0) : (s.type = "gradient", 
                        (270 - u) % 360), e.appendChild(s);
                    }
                    return 1;
                }, A = function(e, r) {
                    this[0] = this.node = e, e.raphael = !0, this.id = t._oid++, e.raphaelid = this.id, 
                    this.X = 0, this.Y = 0, this.attrs = {}, this.paper = r, this.matrix = t.matrix(), 
                    this._ = {
                        transform: [],
                        sx: 1,
                        sy: 1,
                ...
                (A.prototype = T).constructor = A, T.transform = function(e) {
                    ...
                    if (o.translate(1, 1), p || u || "image" == this.type) if (l.matrix = "1 0 0 1", 
                    l.offset = "0 0", s = o.split(), u && s.noRotation || !s.isSimple) {
                        h.style.filter = o.toFilter();
                        var d = this.getBBox(), g = this.getBBox(1), v = d.x - g.x, x = d.y - g.y;
                        h.coordorigin = v * -y + c + x * -y, k(this, 1, 1, v, x, 0);
                    } else h.style.filter = f, k(this, s.scalex, s.scaley, s.dx, s.dy, s.rotate); else h.style.filter = f, 
                    ...
                    if (null != t) {
                        ...
                        return this._.dirtyT = 1, this.transform(this._.transform.concat([ [ "r", t, e, n ] ])), 
                        this;
                    }
                }, T.translate = function(t, e) {
                    return this.removed || ((t = r(t).split(h)).length - 1 && (e = i(t[1])), t = i(t[0]) || 0, 
                    e = +e || 0, this._.bbox && (this._.bbox.x += t, this._.bbox.y += e), this.transform(this._.transform.concat([ [ "t", t, e ] ]))), 
                    this;
                }, T.scale = function(t, e, n, a) {
                    if (this.removed) return this;
                    if ((t = r(t).split(h)).length - 1 && (e = i(t[1]), n = i(t[2]), a = i(t[3]), isNaN(n) && (n = null), 
                    isNaN(a) && (a = null)), t = i(t[0]), null == e && (e = t), null == a && (n = a), 
                    null == n || null == a) var s = this.getBBox(1);
                    return n = null == n ? s.x + s.width / 2 : n, a = null == a ? s.y + s.height / 2 : a, 
                    this.transform(this._.transform.concat([ [ "s", t, e, n, a ] ])), this._.dirtyT = 1, 
                    this;
                }, T.hide = function() {
                    return !this.removed && (this.node.style.display = "none"), this;
                }, T.show = function() {
                    ...
                    if (this.paper && this.paper._viewBoxShift) {
                        ...
                        e.y *= r, e.width = t.width * r, e.height = t.height * r, e.x2 = e.x + e.width, 
                        e.y2 = e.y + e.height, e;
                    }
                    return t;
                }, T._getBBox = function() {
                    ...
                    if (!this.removed && this.node.parentNode) {
                        for (var e in this.paper.__set__ && this.paper.__set__.exclude(this), t.eve.unbind("raphael.*.*." + this.id), 
                    ...
                    var f;
                    for (var p in null != i && ((f = {})[r] = i), null == i && t.is(r, "object") && (f = r), 
                    f) u("raphael.attr." + p + "." + this.id, this, f[p]);
                    if (f) {
                        for (p in this.paper.customAttributes) if (this.paper.customAttributes[e](p) && f[e](p) && t.is(this.paper.customAttributes[p], "function")) {
                            var d = this.paper.customAttributes[p].apply(this, [].concat(f[p]));
                            for (var g in this.attrs[p] = f[p], d) d[e](g) && (f[g] = d[g]);
                    ...
                    return this.removed || (e.constructor == t.st.constructor && (e = e[0]), e.node.parentNode.insertBefore(this.node, e.node), 
                    t._insertbefore(this, e, this.paper)), this;
                }, T.blur = function(e) {
                    var r = this.node.runtimeStyle, i = r.filter;
                    return i = i.replace(g, f), 0 != +e ? (this.attrs.blur = e, r.filter = i + c + " progid:DXImageTransform.Microsoft.Blur(pixelradius=" + (+e || 1.5) + ")", 
                    r.margin = t.format("-{0}px 0 0 -{0}px", a(+e || 1.5))) : (r.filter = i, r.margin = 0, 
                    ...
                    return l.X = h.x = r, l.Y = h.y = i, l.W = h.width = n, l.H = h.height = a, h.r = s, 
                    h.path = o, l.type = "rect", l;
                }, t._engine.ellipse = function(t, e, r, i, n) {
                    var a = t.path();
                    return a.attrs, a.X = e - i, a.Y = r - n, a.W = 2 * i, a.H = 2 * n, a.type = "ellipse", 
                    C(a, {
                        cx: e,
                        cy: r,
                        rx: i,
                    ...
                    var n = t.path();
                    return n.attrs, n.X = e - i, n.Y = r - i, n.W = n.H = 2 * i, n.type = "circle", 
                    C(n, {
                        cx: e,
                        cy: r,
                        r: i
                    ...
                    var o = t._rectPath(i, n, a, s), l = e.path(o).attr({
                        stroke: "none"
                    }), h = l.attrs, u = l.node, c = u.getElementsByTagName("fill")[0];
                    return h.src = r, l.X = h.x = i, l.Y = h.y = n, l.W = h.width = a, l.H = h.height = s, 
                    h.path = o, l.type = "image", c.parentNode == u && u.removeChild(c), c.rotate = !0, 
                    c.src = r, c.type = "tile", l._.fillpos = [ i, n ], l._.fillsize = [ a, s ], u.appendChild(c), 
                    k(l, 1, 1, 0, 0, 0), l;
                }, t._engine.text = function(e, i, n, s) {
                    var o = E("shape"), l = E("path"), h = E("textpath");
                    i = i || 0, n = n || 0, s = s || "", l.v = t.format("m{0},{1}l{2},{1}", a(i * y), a(n * y), a(i * y) + 1), 
                    l.textpathok = !0, h.string = r(s), h.on = !0, o.style.cssText = x, o.coordsize = y + c + y, 
                    o.coordorigin = "0 0";
                    var u = new A(o, e), p = {
                        fill: "#000",
                        stroke: "none",
                    ...
                    u.shape = o, u.path = l, u.textpath = h, u.type = "text", u.attrs.text = r(s), u.attrs.x = i, 
                    u.attrs.y = n, u.attrs.w = 1, u.attrs.h = 1, C(u, p), o.appendChild(h), o.appendChild(l), 
                    e.canvas.appendChild(o);
                    var d = E("skew");
                    return d.on = !0, o.appendChild(d), u.skew = d, u.transform(f), u;
                }, t._engine.setSize = function(e, r) {
                    var i = this.canvas.style;
                    return (this.width = e) == +e && (e += "px"), (this.height = r) == +r && (r += "px"), 
                    i.width = e, i.height = r, i.clip = "rect(0 " + e + " " + r + " 0)", this._viewBox && t._engine.setViewBox.apply(this, this._viewBox), 
                    this;
                    ...
                    return a = a || 0, s = s || 0, n = n || 512, i = i || 342, (o.width = n) == +n && (n += "px"), 
                    (o.height = i) == +i && (i += "px"), o.coordsize = 216e5 + c + 216e5, o.coordorigin = "0 0", 
                    o.span = t._g.doc.createElement("span"), o.span.style.cssText = "position:absolute;left:-9999em;top:-9999em;padding:0;margin:0;line-height:1;", 
                    ...
                    t.eve("raphael.clear", this), this.canvas.innerHTML = f, this.span = t._g.doc.createElement("span"), 
                    this.span.style.cssText = "position:absolute;left:-9999em;top:-9999em;padding:0;margin:0;line-height:1;display:inline;", 
                    this.canvas.appendChild(this.span), this.bottom = this.top = null;
                }, t.prototype.remove = function() {
                    for (var e in t.eve("raphael.remove", this), this.canvas.parentNode.removeChild(this.canvas), 
                    this) this[e] = "function" == typeof this[e] ? t._removedFactory(e) : null;
                    return !0;
                };
                var M = t.st;
