!function(t) {
    ...
    function e(e, n, a, r) {
        ...
        function p() {
            ...
            for (i = 0; i < e; i++) a = t.color.parse(l[i % s] || "#666"), i % s == 0 && i && (c = c >= 0 ? c < .5 ? -c - .2 : 0 : -c), 
            r[i] = a.scale("rgb", 1 + c);
            var f, u = 0;
            for (i = 0; i < K.length; ++i) {
        ...
        function m() {
            ...
            for (e = 0; e < K.length; ++e) {
                if (r = K[e], p = r.data, !(m = r.datapoints.format)) {
                    if ((m = []).push({
                        x: !0,
                        number: !0,
                        required: !0
                ...
                if (null == r.datapoints.pointsize) {
                    ...
                    for (r.xaxis.used = r.yaxis.used = !0, o = n = 0; o < p.length; ++o, n += c) {
                        ...
                        u.y && i(r.yaxis, h, h)), s[n + a] = null; else if (k && n > 0 && null != s[n - c] && s[n - c] != s[n] && s[n - c + 1] != s[n + 1]) {
        ...
        function g(t) {
            ...
            "x" == t.direction ? (e = t.scale = st / Math.abs(n(t.max) - n(t.min)), o = Math.min(n(t.max), n(t.min))) : (e = t.scale = ct / Math.abs(n(t.max) - n(t.min)), 
            e = -e, o = Math.max(n(t.max), n(t.min))), t.p2c = n == i ? function(t) {
                return (t - o) * e;
            } : function(t) {
                return (n(t) - o) * e;
            }, t.c2p = a ? function(t) {
        ...
        function y() {
            ...
            if (null == e) for (e = 0, i = 0; i < K.length; ++i) e = Math.max(e, 2 * (K[i].points.radius + K[i].points.lineWidth / 2));
            var o = {
                left: e,
                right: e,
                top: e,
        ...
        function w() {
            ...
            l(ht.processOffset, [ lt ]);
            for (var n in lt) "object" == typeof Z.grid.borderWidth ? lt[n] += o ? Z.grid.borderWidth[n] : 0 : lt[n] += o ? Z.grid.borderWidth : 0;
            if (t.each(e, function(t, i) {
                ...
                for (t.each(r, function(t, i) {
                    T(i), C(i), S(i, i.ticks), b(i);
                }), i = r.length - 1; i >= 0; --i) v(r[i]);
                y(), t.each(r, function(t, i) {
                    k(i);
                });
            }
        ...
        function M(t) {
            ...
            if (0 == n) {
                ...
                null != r && (null == i.min && (e -= n * r) < 0 && null != t.datamin && t.datamin >= 0 && (e = 0), 
                null == i.max && (o += n * r) > 0 && null != t.datamax && t.datamax <= 0 && (o = 0));
            }
            t.min = e, t.max = o;
        }
        function T(i) {
            var e, n = i.options;
            e = "number" == typeof n.ticks && n.ticks > 0 ? n.ticks : .3 * Math.sqrt("x" == i.direction ? tt.width : tt.height);
            var a = (i.max - i.min) / e, r = -Math.floor(Math.log(a) / Math.LN10), l = n.tickDecimals;
            null != l && r > l && (r = l);
            var s, c = Math.pow(10, -r), h = a / c;
            if (h < 1.5 ? s = 1 : h < 3 ? (s = 2, h > 2.25 && (null == l || r + 1 <= l) && (s = 2.5, 
            ...
            if (i.tickGenerator || (i.tickGenerator = function(t) {
                ...
                if (f && f.used && f != i) {
                    ...
                    if (u.length > 0 && (null == n.min && (i.min = Math.min(i.min, u[0])), null == n.max && u.length > 1 && (i.max = Math.max(i.max, u[u.length - 1]))), 
        ...
        function C(i) {
            ...
            for (i.ticks = [], n = 0; n < o.length; ++n) {
                var r = null, l = o[n];
                "object" == typeof l ? (a = +l[0], l.length > 1 && (r = l[1])) : a = +l, null == r && (r = i.tickFormatter(a, i)), 
        ...
        function S(t, i) {
            t.options.autoscaleMargin && i.length > 0 && (null == t.options.min && (t.min = Math.min(t.min, i[0].v)), 
            null == t.options.max && i.length > 1 && (t.max = Math.max(t.max, i[i.length - 1].v)));
        }
        function W() {
            tt.clear(), l(ht.drawBackground, [ ot ]);
            var t = Z.grid;
            t.show && t.backgroundColor && I(), t.show && !t.aboveData && A();
            for (var i = 0; i < K.length; ++i) l(ht.drawSeries, [ ot, K[i] ]), P(K[i]);
            l(ht.draw, [ ot ]), t.show && t.aboveData && A(), tt.render(), V();
        }
        function z(t, i) {
            for (var e, o, n, a, r = f(), l = 0; l < r.length; ++l) if ((e = r[l]).direction == i && (a = i + e.n + "axis", 
            t[a] || 1 != e.n || (a = i + "axis"), t[a])) {
                o = t[a].from, n = t[a].to;
                break;
            }
            if (t[a] || (e = "x" == i ? at[0] : rt[0], o = t[i + "1"], n = t[i + "2"]), null != o && null != n && o > n) {
                var s = o;
                o = n, n = s;
            }
            return {
        ...
        function I() {
            ot.save(), ot.translate(lt.left, lt.top), ot.fillStyle = $(Z.grid.backgroundColor, ct, 0, "rgba(255, 255, 255, 0)"), 
            ot.fillRect(0, 0, st, ct), ot.restore();
        }
        function A() {
            var i, e, o, n;
            ...
            for (var p = 0; p < e.length; ++p) {
                ...
                if (v.show && 0 != v.ticks.length) {
                    ...
                    ot.beginPath(), i = 0; i < v.ticks.length; ++i) {
                        var w = v.ticks[i].v;
                        g = b = 0, isNaN(w) || w < v.min || w > v.max || "full" == y && ("object" == typeof o && o[v.position] > 0 || o > 0) && (w == v.min || w == v.max) || ("x" == v.direction ? (m = v.p2c(w), 
            ...
            o && (n = Z.grid.borderColor, "object" == typeof o || "object" == typeof n ? ("object" != typeof o && (o = {
                ...
                bottom: n,
                left: n
            }), o.top > 0 && (ot.strokeStyle = n.top, ot.lineWidth = o.top, ot.beginPath(), 
            ot.moveTo(0 - o.left, 0 - o.top / 2), ot.lineTo(st, 0 - o.top / 2), ot.stroke()), 
            o.right > 0 && (ot.strokeStyle = n.right, ot.lineWidth = o.right, ot.beginPath(), 
            ot.moveTo(st + o.right / 2, 0 - o.top), ot.lineTo(st + o.right / 2, ct), ot.stroke()), 
            o.bottom > 0 && (ot.strokeStyle = n.bottom, ot.lineWidth = o.bottom, ot.beginPath(), 
            ot.moveTo(st + o.right, ct + o.bottom / 2), ot.lineTo(0, ct + o.bottom / 2), ot.stroke()), 
            o.left > 0 && (ot.strokeStyle = n.left, ot.lineWidth = o.left, ot.beginPath(), ot.moveTo(0 - o.left / 2, ct + o.bottom), 
        ...
        function P(t) {
            t.lines.show && N(t), t.bars.show && O(t), t.points.show && D(t);
        }
        function N(t) {
                ...
                for (var o = t.points, n = t.pointsize, a = Math.min(Math.max(0, e.min), e.max), r = 0, l = !1, s = 1, c = 0, h = 0; !(n > 0 && r > o.length + n); ) {
                    ...
                    if (null != f && null != d) {
                        ...
                        ot.lineTo(i.p2c(d), e.p2c(e.min)); else {
                            ...
                            p = e.min), u >= p && u > e.max && p <= e.max ? (f = (e.max - u) / (p - u) * (d - f) + f, 
                            u = e.max) : p >= u && p > e.max && u <= e.max && (d = (e.max - u) / (p - u) * (d - f) + f, 
            ...
            }(t.datapoints, t.xaxis, t.yaxis)), e > 0 && i(t.datapoints, 0, 0, t.xaxis, t.yaxis), 
            ot.restore();
        }
        function D(t) {
        ...
        function L(t, i, e, o, n, a, r, l, s, c, h) {
            ...
            u = f, f = v, m = !0, x = !1)) : (m = x = g = !0, b = !1, f = t + o, u = t + n, 
            (p = i) < (d = e) && (v = p, p = d, d = v, b = !0, g = !1)), u < r.min || f > r.max || p < l.min || d > l.max || (f < r.min && (f = r.min, 
            ...
            s.fillRect(f, p, u - f, d - p)), h > 0 && (m || x || g || b) && (s.beginPath(), 
        ...
        function j(t, i, e) {
            ...
            for (o = K.length - 1; o >= 0; --o) if (e(K[o])) {
                ...
                if (c.bars.show && !s) {
                    ...
                    for (M = w + c.bars.barWidth, n = 0; n < u.length; n += a) {
                        ...
                        null != g && ((K[o].bars.horizontal ? d <= Math.max(T, g) && d >= Math.min(T, g) && p >= b + w && p <= b + M : d >= g + w && d <= g + M && p >= Math.min(T, b) && p <= Math.max(T, b)) && (s = [ o, n / a ]));
                    }
                }
            }
        ...
        function X() {
            dt = null, nt.save(), it.clear(), nt.translate(lt.left, lt.top);
            var t, i;
            for (t = 0; t < ut.length; ++t) (i = ut[t]).series.bars.show ? J(i.series, i.point) : U(i.series, i.point);
        ...
        ft.setData = s, ft.setupGrid = w, ft.draw = W, ft.getPlaceholder = function() {
            ...
            var i, e, o, n = {};
            for (i = 0; i < at.length; ++i) if ((e = at[i]) && e.used && (o = "x" + e.n, null == t[o] && 1 == e.n && (o = "x"), 
            null != t[o])) {
                n.left = e.p2c(t[o]);
                break;
            }
            for (i = 0; i < rt.length; ++i) if ((e = rt[i]) && e.used && (o = "y" + e.n, null == t[o] && 1 == e.n && (o = "y"), 
            null != t[o])) {
                n.top = e.p2c(t[o]);
                break;
            }
            ...
            x(), e.removeData("plot").empty(), K = [], Z = null, tt = null, it = null, et = null, 
            ot = null, nt = null, at = [], rt = [], ht = null, ut = [], ft = null;
        }, ft.resize = function() {
            ...
            n = t.extend(!0, {}, Z.xaxis, n), Z.xaxes[o] = n, n.font && (n.font = t.extend({}, c, n.font), 
            ...
            n = t.extend(!0, {}, Z.yaxis, n), Z.yaxes[o] = n, n.font && (n.font = t.extend({}, c, n.font), 
            n.font.color || (n.font.color = n.color), n.font.lineHeight || (n.font.lineHeight = Math.round(1.15 * n.font.size)));
    ...
    t.fn.detach || (t.fn.detach = function() {
        ...
        } else for (var d, f = this.getTextInfo(t, o, a, r).positions, u = 0; d = f[u]; u++) d.x == i && d.y == e && (d.active = !1);
