    ...
    i.c = {}, i.c.d = t(document), i.c.t = function(t) {
        ...
        this.relativeHeight = !1, this.$div = null, this.run = function() {
            ...
            if (!this.$.data("kontroled")) {
                ...
                this.copy(this.v, this.cv)) : this.cv = this.v, this.$.bind("configure", i).parent().bind("configure", i), 
        ...
        this.cursorExt = null, this.w2 = null, this.PI2 = 2 * Math.PI, this.extend = function() {
            ...
            t = this.o.parse(t), !1 !== i && t != this.v && this.rH && !1 === this.rH(t) || (this.cv = this.o.stopper ? s(h(t, this.o.max), this.o.min) : t, 
