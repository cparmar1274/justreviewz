!function(e) {
    e([ "jquery" ], function(e) {
        return function() {
            function t(t, n) {
                return t || (t = c()), (d = e("#" + t.containerId)).length ? d : (n && (d = s(t)), 
                d);
            }
            function n(t) {
                for (var n = d.children(), s = n.length - 1; s >= 0; s--) o(e(n[s]), t);
            }
            function o(t, n, o) {
            ...
            function r(n) {
                ...
                function i() {
                    n.iconClass && x.addClass(b.toastClass).addClass(D);
                }
                function r() {
                    b.newestOnTop ? d.prepend(x) : d.append(x);
                }
                function u() {
                    if (n.title) {
                        var e = n.title;
                ...
                function h() {
                    b.progressBar && (k.addClass(b.progressClass), x.prepend(k));
                }
                function v() {
                    b.rtl && x.addClass("rtl");
                }
                function C(t) {
                ...
                function w() {
                    (b.timeOut > 0 || b.extendedTimeOut > 0) && (H = setTimeout(C, b.extendedTimeOut), 
                ...
                !function(e, t) {
                    ...
                    return i(), u(), g(), m(), h(), v(), r(), s(), x.hide(), x[b.showMethod]({
                        duration: b.showDuration,
                        easing: b.showEasing,
                        complete: b.onShown
                    }), b.timeOut > 0 && (H = setTimeout(C, b.timeOut), M.maxHideTime = parseFloat(b.timeOut), 
                    M.hideEta = new Date().getTime() + M.maxHideTime, b.progressBar && (M.intervalId = setInterval(O, 10))), 
                    b.closeOnHover && x.hover(T, w), !b.onclick && b.tapToDismiss && x.click(C), b.closeButton && I && I.click(function(e) {
