(function() {
    ...
    l = function() {}, t = function() {
        ...
        return e.prototype.addEventListener = e.prototype.on, e.prototype.on = function(e, t) {
            ...
            var e, t, i, n, r;
            if (i = arguments[0], e = 2 <= arguments.length ? u.call(arguments, 1) : [], this._callbacks = this._callbacks || {}, 
            t = this._callbacks[i]) for (n = 0, r = t.length; n < r; n++) t[n].apply(this, e);
            return this;
        ...
        function n(e, t) {
            ...
            if (n.instances.push(this), this.element.dropzone = this, i = null != (o = n.optionsForElement(this.element)) ? o : {}, 
            this.options = r({}, this.defaultOptions, i, null != t ? t : {}), this.options.forceFallback || !n.isBrowserSupported()) return this.options.fallback.call(this);
            ...
            }(this)), this.options.method = this.options.method.toUpperCase(), (s = this.getExistingFallback()) && s.parentNode && s.parentNode.removeChild(s), 
            !1 !== this.options.previewsContainer && (this.options.previewsContainer ? this.previewsContainer = n.getElement(this.options.previewsContainer, "previewsContainer") : this.previewsContainer = this.element), 
            this.options.clickable && (!0 === this.options.clickable ? this.clickableElements = [ this.element ] : this.clickableElements = n.getElements(this.options.clickable, "clickable")), 
            this.init();
        }
        var r, s;
        ...
        n.prototype.defaultOptions = {
            ...
            addedfile: function(e) {
                ...
                this.previewsContainer) {
                    for (e.previewElement = n.createElement(this.options.previewTemplate.trim()), e.previewTemplate = e.previewElement, 
                    this.previewsContainer.appendChild(e.previewElement), t = 0, s = (a = e.previewElement.querySelectorAll("[data-dz-name]")).length; t < s; t++) a[t].textContent = e.name;
                    for (i = 0, o = (u = e.previewElement.querySelectorAll("[data-dz-size]")).length; i < o; i++) u[i].innerHTML = this.filesize(e.size);
                    for (this.options.addRemoveLinks && (e._removeLink = n.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictRemoveFile + "</a>"), 
                    e.previewElement.appendChild(e._removeLink)), c = function(t) {
                        return function(i) {
                    ...
                    }(this), h = [], r = 0, l = (p = e.previewElement.querySelectorAll("[data-dz-remove]")).length; r < l; r++) d = p[r], 
                    h.push(d.addEventListener("click", c));
                    return h;
                }
            },
            ...
            thumbnail: function(e, t) {
                var i, n, r, s;
                if (e.previewElement) {
                    for (e.previewElement.classList.remove("dz-file-preview"), i = 0, n = (r = e.previewElement.querySelectorAll("[data-dz-thumbnail]")).length; i < n; i++) (s = r[i]).alt = e.name, 
                    s.src = t;
            ...
            error: function(e, t) {
                ...
                if (e.previewElement) {
                    ...
                    o = [], i = 0, n = (s = e.previewElement.querySelectorAll("[data-dz-errormessage]")).length; i < n; i++) r = s[i], 
                    o.push(r.textContent = t);
                    return o;
                }
            },
            errormultiple: l,
            ...
            this.clickableElements.length && (l = function(e) {
                return function() {
                    ...
                    e.hiddenFileInput.addEventListener("change", function() {
                        var t, i, n, r;
                        if ((i = e.hiddenFileInput.files).length) for (n = 0, r = i.length; n < r; n++) t = i[n], 
                        e.addFile(t);
                        return e.emit("addedfiles", i), l();
                    });
                };
            }(this))(), this.URL = null != (s = window.URL) ? s : window.webkitURL, t = 0, i = (o = this.events).length; t < i; t++) e = o[t], 
            ...
            return this.on("uploadprogress", function(e) {
                ...
                return function(t) {
                    return e.listeners.push({
                        ...
                        events: {
                            click: function(i) {
                                return (t !== e.element || i.target === e.element || n.elementInside(i.target, e.element.querySelector(".dz-message"))) && e.hiddenFileInput.click(), 
                                !0;
                            }
                        }
                    });
            ...
            t = n.createElement(i), "FORM" !== this.element.tagName ? (r = n.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>')).appendChild(t) : (this.element.setAttribute("enctype", "multipart/form-data"), 
            ...
            }), this.removeEventListeners(), r = [], t = 0, i = (n = this.files).length; t < i; t++) e = n[t], 
            ...
            return "<strong>" + s + "</strong> " + this.options.dictFileSizeUnits[o];
            ...
            return this.createThumbnail(e, t, r, s, !1, function(t) {
                return function(r, s) {
                    var l, a;
                    return null === s ? o(e) : (null == (l = t.options.resizeMimeType) && (l = e.type), 
                    a = s.toDataURL(l, t.options.resizeQuality), "image/jpeg" !== l && "image/jpg" !== l || (a = i.restore(e.dataURL, a)), 
                    o(n.dataURItoBlob(a)));
                };
            }(this));
            ...
            return a = document.createElement("img"), l && (a.crossOrigin = l), a.onload = function(l) {
                return function() {
                    ...
                    return u = function(e) {
                        ...
                        if (o(p, a, null != (c = f.srcX) ? c : 0, null != (d = f.srcY) ? d : 0, f.srcWidth, f.srcHeight, null != (h = f.trgX) ? h : 0, null != (m = f.trgY) ? m : 0, f.trgWidth, f.trgHeight), 
                        g = u.toDataURL("image/png"), null != s) return s(g, u);
                    });
                };
            ...
            var t, i, r;
            for (i = 0, r = e.length; i < r; i++) (t = e[i]).processing = !0, t.status = n.UPLOADING, 
            ...
            } else (a = e.status) !== n.ADDED && a !== n.QUEUED || (e.status = n.CANCELED, this.emit("canceled", e), 
            ...
            O.withCredentials = !!this.options.withCredentials, I = null, a = function(t) {
                ...
                return function(i) {
                    ...
                    if (null != i) for (c = 100 * i.loaded / i.total, r = 0, l = e.length; r < l; r++) (o = e[r]).upload.progress = c, 
                    o.upload.total = i.total, o.upload.bytesSent = i.loaded; else {
                        for (n = !0, c = 100, s = 0, a = e.length; s < a; s++) 100 === (o = e[s]).upload.progress && o.upload.bytesSent === o.upload.total || (n = !1), 
                        o.upload.progress = c, o.upload.bytesSent = o.upload.total;
                        if (n) return;
                    }
                ...
                return function(i) {
                    ...
                    if (e[0].status !== n.CANCELED && 4 === O.readyState) {
                        if ("arraybuffer" !== O.responseType && "blob" !== O.responseType && (I = O.responseText, 
                        O.getResponseHeader("content-type") && ~O.getResponseHeader("content-type").indexOf("application/json"))) try {
                            I = JSON.parse(I);
                        } catch (e) {
            ...
            var r, s, o;
            for (s = 0, o = e.length; s < o; s++) (r = e[s]).status = n.SUCCESS, this.emit("success", r, t, i), 
            this.emit("complete", r);
            if (this.options.uploadMultiple && (this.emit("successmultiple", e, t, i), this.emit("completemultiple", e)), 
            this.options.autoProcessQueue) return this.processQueue();
        }, n.prototype._errorProcessing = function(e, t, i) {
            var r, s, o;
            for (s = 0, o = e.length; s < o; s++) (r = e[s]).status = n.ERROR, this.emit("error", r, t, i), 
            this.emit("complete", r);
            if (this.options.uploadMultiple && (this.emit("errormultiple", e, t, i), this.emit("completemultiple", e)), 
            this.options.autoProcessQueue) return this.processQueue();
        }, n;
        ...
        (t = function(e) {
            var t, i, r, s;
            for (s = [], i = 0, r = e.length; i < r; i++) /(^| )dropzone($| )/.test((t = e[i]).className) ? s.push(n.push(t)) : s.push(void 0);
            return s;
        })(document.getElementsByTagName("div")), t(document.getElementsByTagName("form"))), 
        o = [], r = 0, s = n.length; r < s; r++) i = n[r], !1 !== e.optionsForElement(i) ? o.push(new e(i)) : o.push(void 0);
        return o;
    }, e.blacklistedBrowsers = [ /opera.*Macintosh.*version\/12/i ], e.isBrowserSupported = function() {
        var t, i, n, r;
        if (t = !0, window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector) if ("classList" in document.createElement("a")) for (i = 0, 
        n = (r = e.blacklistedBrowsers).length; i < n; i++) r[i].test(navigator.userAgent) && (t = !1); else t = !1; else t = !1;
        return t;
    ...
    s = function(e) {
        ...
        e.encode64 = function(e) {
            ...
            r = this.slice2Segments(n), i = this.exifManipulation(t, r), "data:image/jpeg;base64," + this.encode64(i)) : t;
        ...
        s = function(i) {
            ...
            return n[i](l + "DOMContentLoaded", s, !1), n[i](l + "readystatechange", s, !1), 
            e[i](l + "load", s, !1);
        }
