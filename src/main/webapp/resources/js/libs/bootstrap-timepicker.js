!function(t, i, e) {
    "use strict";
    var s = function(i, e) {
        this.widget = "", this.$element = t(i), this.defaultTime = e.defaultTime, this.disableFocus = e.disableFocus, 
        this.disableMousewheel = e.disableMousewheel, this.isOpen = e.isOpen, this.minuteStep = e.minuteStep, 
        this.modalBackdrop = e.modalBackdrop, this.orientation = e.orientation, this.secondStep = e.secondStep, 
        this.snapToStep = e.snapToStep, this.showInputs = e.showInputs, this.showMeridian = e.showMeridian, 
        this.showSeconds = e.showSeconds, this.template = e.template, this.appendWidgetTo = e.appendWidgetTo, 
        this.showWidgetOnAddonClick = e.showWidgetOnAddonClick, this.icons = e.icons, this.maxHours = e.maxHours, 
        this.explicitMode = e.explicitMode, this.handleDocumentClick = function(t) {
            var i = t.data.scope;
    ...
    s.prototype = {
        ...
        decrementMinute: function(t) {
            var i;
            (i = t ? this.minute - t : this.minute - this.minuteStep) < 0 ? (this.decrementHour(), 
        ...
        incrementHour: function() {
            ...
            this.hour !== this.maxHours - 1 ? this.hour++ : this.hour = 0;
        },
        ...
        place: function() {
            if (!this.isInline) {
                var e = this.$widget.outerWidth(), s = this.$widget.outerHeight(), h = t(i).width(), n = t(i).height(), o = t(i).scrollTop(), a = parseInt(this.$element.parents().filter(function() {
                    return "auto" !== t(this).css("z-index");
                }).first().css("z-index"), 10) + 10, r = this.component ? this.component.parent().offset() : this.$element.offset(), d = this.component ? this.component.outerHeight(!0) : this.$element.outerHeight(!1), c = this.component ? this.component.outerWidth(!0) : this.$element.outerWidth(!1), l = r.left, u = r.top;
                this.$widget.removeClass("timepicker-orient-top timepicker-orient-bottom timepicker-orient-right timepicker-orient-left"), 
                "auto" !== this.orientation.x ? (this.$widget.addClass("timepicker-orient-" + this.orientation.x), 
                "right" === this.orientation.x && (l -= e - c)) : (this.$widget.addClass("timepicker-orient-left"), 
                r.left < 0 ? l -= r.left - 10 : r.left + e > h && (l = h - e - 10));
                var p, m, g = this.orientation.y;
                "auto" === g && (p = -o + r.top - s, m = o + n - (r.top + d + s), g = Math.max(p, m) === m ? "top" : "bottom"), 
                this.$widget.addClass("timepicker-orient-" + g), "top" === g ? u += d : u -= s + parseInt(this.$widget.css("padding-top"), 10), 
                this.$widget.css({
                    top: u,
                    left: l,
                    zIndex: a
        ...
        setTime: function(t, i) {
            if (t) {
                ...
                this.second = this.changeToNearestStep(o, this.secondStep)) : (this.minute = n, 
                this.second = o), this.meridian = a, this.update(i);
            } else this.clear();
        },
        showWidget: function() {
            this.isOpen || this.$element.is(":disabled") || (this.$widget.appendTo(this.appendWidgetTo), 
            t(e).on("mousedown.timepicker, touchend.timepicker", {
                scope: this
        ...
        updateWidget: function() {
            if (!1 !== this.$widget) {
                ...
                this.$widget.find("input.bootstrap-timepicker-minute").val(i), this.showSeconds && this.$widget.find("input.bootstrap-timepicker-second").val(e), 
                ...
                this.$widget.find("span.bootstrap-timepicker-minute").text(i), this.showSeconds && this.$widget.find("span.bootstrap-timepicker-second").text(e), 
        ...
        return e.shift(), this.each(function() {
            ...
            n || h.data("timepicker", n = new s(this, t.extend({}, t.fn.timepicker.defaults, o, t(this).data()))), 
