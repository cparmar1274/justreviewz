!function(e, t) {
    ...
    var t = function(e, t) {
        ...
        var r = 1;
        window.devicePixelRatio > 1 && (r = window.devicePixelRatio, a.style.width = a.style.height = [ t.size, "px" ].join(""), 
        ...
        var s = function(e, t, n) {
            ...
            for (var a = 24; a > 0; --a) a % 6 == 0 ? (n = t.scaleLength, e = 0) : (n = .6 * t.scaleLength, 
            e = t.scaleLength - n), i.fillRect(-t.size / 2 + e, 0, n, 1), i.rotate(Math.PI / 12);
            i.restore();
        ...
        this.getCanvas = function() {
            ...
            n = i.getImageData(0, 0, t.size * r, t.size * r)) : (this.clear(), l()) : this.clear(), 
            i.lineCap = t.lineCap;
            var a;
        ...
        var i = {}, r = 0, o = function() {
            ...
            for (var t in a) a.hasOwnProperty(t) && (i[t] = n && void 0 !== n[t] ? n[t] : a[t], 
