!function(t) {
    ...
    t.fn.timepicker.Constructor.prototype._init = function() {
        ...
        this.showInputs ? (t = '<input type="text" name="hour" class="bootstrap-timepicker-hour form-control timepicker-input" maxlength="2"/>', 
        ...
        n = '<input type="text" name="meridian" class="bootstrap-timepicker-meridian form-control timepicker-input" maxlength="2"/>') : (t = '<span class="bootstrap-timepicker-hour timepicker-value"></span>', 
        ...
        n = '<span class="bootstrap-timepicker-meridian timepicker-value"></span>');
