...
var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
    ...
    var e = "pxWizard", i = ".px.wizard", n = t.fn[e], s = {
        ...
        function n(e, i) {
            ...
            this.steps = t(e).find("." + r.STEPS)[0], this.stepItems = t(this.steps).find("li"), 
            this.wrapper = t(e).find("." + r.WRAPPER)[0], this.config = this._getConfig(i), 
        ...
        return _createClass(n, [ {
            ...
            value: function() {
                var e = this.activeStep || t(this.steps).find("li." + r.ACTIVE)[0];
            ...
            value: function(t) {
                if (!this.isFrozen() && !this.isFinished()) {
                    var e = void 0, i = void 0, n = void 0, s = this._getStepItemAndTarget(t), r = _slicedToArray(s, 3);
                    i = r[0], e = r[1], n = r[2];
            ...
            key: "getPaneByIndex",
            value: function(e) {
                var i = void 0, n = this._getStepItemAndTarget(e), s = _slicedToArray(n, 3);
            ...
            value: function() {
                if (!this.isFrozen() && !this.isFinished() && this._triggerPreventableEvent("FINISH", this.element)) {
                    ...
                    t !== e && this.goTo(e), pxUtil.addClass(this.element, r.FINISHED), this.freeze(), 
            ...
            key: "isFinished",
            value: function() {
                return pxUtil.hasClass(this.element, r.FINISHED);
            }
        }, {
            key: "freeze",
            value: function() {
                pxUtil.addClass(this.element, r.FROZEN), this._triggerEvent("FROZEN", this.element);
            }
        }, {
            key: "unfreeze",
            value: function() {
                this.isFinished() || (pxUtil.removeClass(this.element, r.FROZEN), this._triggerEvent("UNFROZEN", this.element));
            }
        }, {
            key: "isFrozen",
            value: function() {
                return pxUtil.hasClass(this.element, r.FROZEN);
            }
        }, {
            key: "reset",
            value: function() {
                var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                pxUtil.removeClass(this.element, r.FROZEN), pxUtil.removeClass(this.element, r.FINISHED), 
            ...
            value: function(t) {
                ...
                if ("number" == typeof t) {
                    if (e = this.stepItems[t], i = t, !e) throw new Error('Step item with index "' + t + '" is not found.');
            ...
            value: function(t, e) {
                pxUtil.addClass(t, r.ACTIVE), pxUtil.removeClass(t, r.COMPLETED);
                for (var i = 0; i < e; i++) pxUtil.addClass(this.stepItems[i], r.COMPLETED), pxUtil.removeClass(this.stepItems[i], r.ACTIVE);
                for (var n = e + 1, s = this.stepItems.length; n < s; n++) pxUtil.removeClass(this.stepItems[n], r.ACTIVE), 
                pxUtil.removeClass(this.stepItems[n], r.COMPLETED);
                this._placeStepsContainer();
            }
        }, {
            key: "_activateStepPane",
            value: function(e) {
                for (var i = t(this.element).find("." + r.PANE + "." + r.ACTIVE), n = 0, s = i.length; n < s; n++) pxUtil.removeClass(i[n], r.ACTIVE);
                pxUtil.addClass(t(this.element).find(e)[0], r.ACTIVE);
            }
        }, {
            ...
            value: function() {
                ...
                this._isRtl && (r = i - r - n), i > e && r > s ? i + (a = -1 * r + s) < e && (a = -1 * i + e) : a = 0, 
            ...
            value: function() {
                ...
                t(this.steps).on(this.constructor.Event.CLICK, "> li", function() {
                    pxUtil.hasClass(this, r.COMPLETED) && e.goTo(this);
            ...
            value: function(e, i) {
                var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, s = t.Event(this.constructor.Event[e], {
                    target: i
                });
